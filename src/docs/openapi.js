        ...
        parameters: [
          {
            ...
            description:
              'Free-text search, for example `mascara`, `mascra` (typo) or `cellphones` (synonym). Blank is treated as absent.',
          },
          {
            name: 'category',
            in: 'query',
            ...
            description:
              'Category slug such as `smartphones`, matched case-insensitively. Unknown slugs return an empty list.',
          },
          {
            name: 'minRating',
            in: 'query',
            schema: { type: 'number', minimum: 0, maximum: 5 },
            description: 'Only products rated at least this value, for example `4`.',
          },
          {
            name: 'minPrice',
            in: 'query',
          ...
          },
          {
            ...
            in: 'query',
            schema: { type: 'number', minimum: 0 },
            description: 'Highest price to include. Must not be lower than minPrice.',
          },
          {
            name: 'page',
            in: 'query',
